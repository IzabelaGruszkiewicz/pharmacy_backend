...
//    @PostMapping(value = "/addToMagazine/{productId}/{howMany}")
//    public ResponseEntity<ProductDto> addProductToMagazine(
//    ) {
//        ProductDto productDto = productService.addProductToMagazine(productCreate);
//        return ResponseEntity.ok().body(productDto);
//    }
}
